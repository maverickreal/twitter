package org.twitter.backend.configurations.security.mail;
...
public class MailConfiguration {
    ...
    private static final String CREDENTIALS_FILE_PATH = new FileSystemResource("")
            .getFile().getAbsolutePath() + "\\google_api_oauth2_client.json";
